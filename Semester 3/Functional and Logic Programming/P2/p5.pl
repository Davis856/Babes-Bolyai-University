...
% InitialList - the list with which we have to concatenate the new
% elements
...
% replaceFirsElementInSublist(List: list, ReplacementList: list, Result:
% list)
% flow mode:(i,i,o),(i,i,i),(i,o,i)
% List - initial list
% ReplacemntList - the list that will replace all occurences the first
% element from the sublists
% Result - final list
