...
class UI:
    ...
    def __ui_get_edge_cost(self):
        ...
        if vertices_number == 0:
            ...
            try:
                ...
                print("The integer attached (the cost) to the edge ", source_vertex, " -> ", destination_vertex,
                      " is: ", cost)
            except GraphExceptions as e:
                print(e)
            except ValueError:
    ...
    def __ui_copy_graph(self):
        ...
        print(
            "Below is the list of the graphs vertices so you can see that it's an accurate copy of the original graph.")
