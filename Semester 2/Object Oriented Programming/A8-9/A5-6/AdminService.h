...
public:
	...
	void addCoat(size_t size, std::string colour, size_t price, size_t quantity, std::string photograph);

	/// <summary>
	/// Remove a certain coat from the repository
	/// </summary>
	/// <param name="size">The size of the coat to be removed</param>
	void removeCoat(size_t size);
	...
	void updateCoatSize(size_t size, size_t newSize);
	...
	void updateCoatColour(size_t size, std::string newColour);
	...
	void updateCoatPrice(size_t size, size_t newPrice);
	...
	void updateCoatPhotograph(size_t size, std::string newPhotograph);
